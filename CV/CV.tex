...
\begin{itemize}[leftmargin=*]
    \item (March 26 --- June 26) Corca Research, Mathematician, project-based engagement. 
    
     The development of the prototype recognising a mathematical text written in natural language
     into a custom designed data structure. That data structure stores a collection of well-typed abstract syntax trees of typed-theoretic declarations relfecting mathematical entities from the original text whenever
...
\begin{itemize}
    ...
    \item Educating colleagues in mathematical logic, analytic philosophy of language, denotational semantics, universal algebra, type theory, programming language theory, etc.
\end{itemize}
